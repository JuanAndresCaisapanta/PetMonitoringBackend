...
import com.Pet_Monitoring.Dto.DispositivosDto;
import com.Pet_Monitoring.Dto.Mensaje;
import com.Pet_Monitoring.Entity.Device;
import com.Pet_Monitoring.Service.DispositivosService;
...
public class DispositivoControlador {
	...
	public ResponseEntity<List<Device>> lista() {
		List<Device> list = dispositivosService.lista();
